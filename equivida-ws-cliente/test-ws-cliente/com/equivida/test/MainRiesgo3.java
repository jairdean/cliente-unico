...
public class MainRiesgo3 {
	...
	public static void main(String[] args) throws Exception {
		...
		//URL url = new URL("http://10.10.52.108/RCS%20WS%20OFAC/service.asmx");

		//http://10.10.52.108/RCS%20WS%20OFAC/Service.asmx?WSDL
		//16 de nov de 2016
		URL url = new URL("http://10.10.52.108/RCS%20WS%20OFAC/Service.asmx?wsdl");
		...
		while (itDiff.hasNext()) {
			...
			System.out.println("resultadosRevisionOFACME:"+resultadosRevisionOFACME.getAsString());
