...
public class ResultadosRevisionOFAC  implements java.io.Serializable {
    ...
    private localhost.ResultadosRevisionOFAC_xsd.ResultadosRevisionOFACResultadosOFACSwift resultadosOFACSwift;
    ...
    public ResultadosRevisionOFAC(
           ...
           localhost.ResultadosRevisionOFAC_xsd.ResultadosRevisionOFACResultadosOFACSwift resultadosOFACSwift) {
           this.resultadosOFAC = resultadosOFAC;
           this.resultadosOFACSwift = resultadosOFACSwift;
    }
    ...
    /**
     * Gets the resultadosOFACSwift value for this ResultadosRevisionOFAC.
     * 
     * @return resultadosOFACSwift
     */
    public localhost.ResultadosRevisionOFAC_xsd.ResultadosRevisionOFACResultadosOFACSwift getResultadosOFACSwift() {
        return resultadosOFACSwift;
    }


    /**
     * Sets the resultadosOFACSwift value for this ResultadosRevisionOFAC.
     * 
     * @param resultadosOFACSwift
     */
    public void setResultadosOFACSwift(localhost.ResultadosRevisionOFAC_xsd.ResultadosRevisionOFACResultadosOFACSwift resultadosOFACSwift) {
        this.resultadosOFACSwift = resultadosOFACSwift;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ...
            ((this.resultadosOFACSwift==null && other.getResultadosOFACSwift()==null) || 
             (this.resultadosOFACSwift!=null &&
              this.resultadosOFACSwift.equals(other.getResultadosOFACSwift())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getResultadosOFACSwift() != null) {
            _hashCode += getResultadosOFACSwift().hashCode();
        }
    ...
    static {
        ...
        elemField.setFieldName("resultadosOFACSwift");
        elemField.setXmlName(new javax.xml.namespace.QName("http://localhost/ResultadosRevisionOFAC.xsd", "ResultadosOFACSwift"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://localhost/ResultadosRevisionOFAC.xsd", ">>ResultadosRevisionOFAC>ResultadosOFACSwift"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
