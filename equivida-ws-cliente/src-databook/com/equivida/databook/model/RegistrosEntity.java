...
public class RegistrosEntity {
	...
	public static class Direcciones {
		...
		@XmlElement
		protected Direccion1 direccion1;
		@XmlElement
		protected Direccion2 direccion2;

		/**
		 * Gets the value of the direccion1 property.
		 * 
		 * @return possible object is {@link Direccion1 }
		 * 
		 */
		 ...
		 * 
		 * @param value allowed object is {@link Direccion1 }
		 * 
		 */
		public void setDireccion1(Direccion1 value) {
		 ...
		 * 
		 * @return possible object is {@link Direccion2 }
		 * 
		 */
		 ...
		 * 
		 * @param value allowed object is {@link Direccion2 }
		 * 
		 */
		public void setDireccion2(Direccion2 value) {
	...
	@XmlRootElement(name = "direccion1")
	public static class Direccion1 {
	...
	@XmlType(name = "", propOrder = { "numero", "secParroquia", "direccion", "referencia", "secProvincia", "secCanton",
			"tipoDireccion", "callePrincipal", "calleSecundaria" })
	@XmlRootElement(name = "direccion2")
	public static class Direccion2 {
