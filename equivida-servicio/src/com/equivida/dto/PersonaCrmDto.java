...
public class PersonaCrmDto {
	...
	private String conyugeNombre1;
	private String conyugeNombre2;
	private String conyugeApePat;
	private String conyugeApeMat;
	...
	//private String emailAlterno;//ya no se usa, ahora se usa tipoEmail
	...
	public String getConyugeNombre1() {
		return conyugeNombre1;
	}

	public void setConyugeNombre1(String conyugeNombre1) {
		this.conyugeNombre1 = conyugeNombre1;
	}

	public String getConyugeNombre2() {
		return conyugeNombre2;
	}

	public void setConyugeNombre2(String conyugeNombre2) {
		this.conyugeNombre2 = conyugeNombre2;
	}

	public String getConyugeApePat() {
		return conyugeApePat;
	}

	public void setConyugeApePat(String conyugeApePat) {
		this.conyugeApePat = conyugeApePat;
	}

	public String getConyugeApeMat() {
		return conyugeApeMat;
	}

	public void setConyugeApeMat(String conyugeApeMat) {
		this.conyugeApeMat = conyugeApeMat;
	}
}