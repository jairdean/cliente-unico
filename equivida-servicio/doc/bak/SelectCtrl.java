...
public class SelectCtrl extends BaseCtrl {
	...
	/**
	 * @param estadoCivilItems
	 *            the estadoCivilItems to set
	 */
	...
	public List<SelectItem> getTipoEmpleoItems() {
		if (tipoEmpleoItems == null) {
			...
			for (TipoOtraOcupacion tipo : lista) {
				tipoEmpleoItems.add(new SelectItem(tipo.getCodOtraOcupacion(),
						tipo.getOtraOcupacion()));
			}
	...
	/**
	 * @param tipoOficioItems
	 *            the tipoOficioItems to set
	 */
	...
	public List<SelectItem> getTipoPeronaJuridicaItems() {
		...
		if (tipoPeronaJuridicaItems == null) {
			...
			List<TipoPersonaJuridica> tmpList = tipoPersonaJuridicaServicio
					.findAll();
			for (TipoPersonaJuridica tipoPersonaJuridica : tmpList) {
				SelectItem item = new SelectItem(
						tipoPersonaJuridica.getCodTipoPersonaJuridica(),
	...
	/**
	 * @param tipoPeronaJuridicaItems
	 *            the tipoPeronaJuridicaItems to set
	 */
	public void setTipoPeronaJuridicaItems(
			List<SelectItem> tipoPeronaJuridicaItems) {
	...
	public List<SelectItem> getGeneroItems() {
		...
		if (generoItems == null) {
			...
			for (SexoEnum item : values) {
				generoItems.add(new SelectItem(item.getCodigo(), item
						.toString()));
			}
		}
		return generoItems;
	...
	public List<SelectItem> getTipoDocumentoItems() {
		...
		if (tipoDocumentoItems == null) {
			...
			List<TipoIdentificacion> tmpList = tipoIdentificacionServicio
					.findAll();
	...
	public List<SelectItem> getTipoDireccionItems() {
		if (tipoDireccionItems == null) {
			...
			for (TipoDireccion tipoDireccion : tmpList) {
				SelectItem item = new SelectItem(
						tipoDireccion.getCodTipoDireccion(),
	...
	/**
	 * @param tipoDireccionItems
	 *            the tipoDireccionItems to set
	 */
	...
	public List<SelectItem> getTipoDireccionElectronicaItems() {
		if (tipoDireccionElectronicaItems == null) {
			...
			List<TipoDireccionElectronica> tmpList = tipoDireccionElectronicaServicio
					.findAll();
			for (TipoDireccionElectronica te : tmpList) {
				SelectItem item = new SelectItem(
						te.getCodTipoDireccionElectronica(),
						te.getTipoDireccionElectronica());
	...
	/**
	 * @param tipoDireccionElectronicaItems
	 *            the tipoDireccionElectronicaItems to set
	 */
	public void setTipoDireccionElectronicaItems(
			List<SelectItem> tipoDireccionElectronicaItems) {
	...
	public List<SelectItem> getTipoTelefonoItems() {
		if (tipoTelefonoItems == null) {
			...
			List<TipoTelefono> tmpList = tipoTelefonoServicio
					.findByCriterias(criteria);

			for (TipoTelefono tipoTlf : tmpList) {
				SelectItem item = new SelectItem(tipoTlf.getCodTipoTelefono(),
						tipoTlf.getTipoTelefono());
	...
	/**
	 * @param tipoTelefonoItems
	 *            the tipoTelefonoItems to set
	 */
	...
	public List<SelectItem> getTipoTelefonoSinDireccionItems() {
		...
		if (tipoTelefonoSinDireccionItems == null) {
			...
			String[] criteriasAnd = { "reqDireccion", "codTipoTelefono",
					"codigoVisible" };
			CriteriaTypeEnum[] typesAnd = { CriteriaTypeEnum.STRING_EQUALS,
					CriteriaTypeEnum.SHORT_NOT_EQUALS,
					CriteriaTypeEnum.STRING_EQUALS };
			Object[] params = new Object[] { RespuestaEnum.NO.getCodigo(),
					new Integer(0).shortValue(), RespuestaEnum.SI.getCodigo() };
			Criteria criteria = new Criteria(criteriasAnd, typesAnd, params);
	...
	/**
	 * @param tipoTelefonoSinDireccionItems
	 *            the tipoTelefonoSinDireccionItems to set
	 */
	public void setTipoTelefonoSinDireccionItems(
			List<SelectItem> tipoTelefonoSinDireccionItems) {
	...
	/**
	 * @param actividadesItems
	 *            the actividadesItems to set
	 */
	...
	/**
	 * @param tipoBeneficiarioItems
	 *            the tipoBeneficiarioItems to set
	 */
	...
	public List<SelectItem> getCategoriaPepItems() {
		...
		if (categoriaPepItems == null) {
			...
			List<CategoriaPpe> categoriaPpeList = categoriaPpeServicio
					.findAll();
			for (CategoriaPpe categoriaPpe : categoriaPpeList) {
				SelectItem item = new SelectItem(
						categoriaPpe.getCodCategoriaPpe(),
						categoriaPpe.getCategoriaPpe());
	 ...
	 * 
	 * @param categoriaPepItems
	 *            the categoriaPepItems to set
	 */
	...
	public void setTipoParentescoRelacionServicio(
			TipoParentescoRelacionServicio tipoParentescoRelacionServicio) {
	...
	public List<SelectItem> getTipoParentescoFamiliaresYNoFamiliaresItems() {
		if (tipoParentescoFamiliaresYNoFamiliaresItems == null) {
			...
			Criteria criteria = new Criteria(criteriasAnd, typesAnd, params,
					orderBy, asc);
			List<TipoParentescoRelacion> tmpList = tipoParentescoRelacionServicio
					.findByCriterias(criteria);

			for (TipoParentescoRelacion tipo : tmpList) {
				SelectItem item = new SelectItem(tipo.getCodTipoParentesco(),
						tipo.getTipoParentesco());
	...
	public void setTipoParentescoFamiliaresItems(
			List<SelectItem> tipoParentescoFamiliaresItems) {
	...
	public List<SelectItem> getEstadoCivilVisiblesItems() {
		if (estadoCivilVisiblesItems == null) {
			...
			List<EstadoCivil> tmpList = estadoCivilServicio
					.findByCriterias(criteria);
			for (EstadoCivil estadoCivil : tmpList) {
				SelectItem item = new SelectItem(
						estadoCivil.getCodEstadoCivil(),
	...
	public void setEstadoCivilVisiblesItems(
			List<SelectItem> estadoCivilVisiblesItems) {
		...
		if (tipoDocumentoParaPersonaNaturalItems == null) {
			...
			for (TipoIdentificacion tipoIdentificacion : tmpList) {
				if (TipoIdentificacionEnum
						.isParaIngresoPersonaNatural(tipoIdentificacion
								.getCodTipoIdentificacion().charValue())) {
					SelectItem item = new SelectItem(
							tipoIdentificacion.getCodTipoIdentificacion(),
							tipoIdentificacion.getTipoIdentificacion());
	...
	public void setTipoDocumentoParaPersonaNaturalItems(
			List<SelectItem> tipoDocumentoParaPersonaNaturalItems) {
	...
	public List<SelectItem> getTipoRiesgoItems() {
		if (tipoRiesgoItems == null) {
			...
			for (TipoRiesgo tipoRiesgo : tmpList) {
				...
				SelectItem item = new SelectItem(tipoRiesgo.getCodTipoRiesgo(),
	...
	public List<SelectItem> getDeportesItems() {
		if (deportesItems == null) {
			...
			for (Deporte d : tmpList) {
				SelectItem si = new SelectItem(d.getCodDeporte(),
						d.getDeporte());
	...
	public List<SelectItem> getTipoDeportePracticaItems() {
		if (tipoDeportePracticaItems == null) {
			...
			for (TipoDeportePracticaEnum t : values) {
				SelectItem si = new SelectItem(t.getCodigo(),
						getBundleEtiquetas(t.getKeyBundle(), null));
	...
	public void setTipoDeportePracticaItems(
			List<SelectItem> tipoDeportePracticaItems) {
	...
	public List<SelectItem> getTipoDocumentoParaBeneficiacioItems() {
		if (tipoDocumentoParaBeneficiacioItems == null) {
			if (tipoDocumentoParaBeneficiacioItems == null) {
				...
				for (TipoIdentificacion tipoIdentificacion : tmpList) {
					if (TipoIdentificacionEnum
							.isParaIngresoBeneficiario(tipoIdentificacion
									.getCodTipoIdentificacion().charValue())) {
						SelectItem item = new SelectItem(
								tipoIdentificacion.getCodTipoIdentificacion(),
								tipoIdentificacion.getTipoIdentificacion());
	...
	public void setTipoDocumentoParaBeneficiacioItems(
			List<SelectItem> tipoDocumentoParaBeneficiacioItems) {
	...
	public List<SelectItem> getTipoEstadoPersonaItems() {
		if (tipoEstadoPersonaItems == null) {
			...
			for (TipoEstado te : tmpList) {
				SelectItem si = new SelectItem(te.getCodEstado(),
						te.getEstadoAsegurado());
	...
	public void setTipoEstadoPersonaItems(
			List<SelectItem> tipoEstadoPersonaItems) {
	...
	public List<SelectItem> getInstitucionFinancieraItems() {
		if (institucionFinancieraItems == null) {
			List<InstitucionFinanciera> lista = institucionFinancieraServicio
					.obtenerOrdenadoPorNombre();
			institucionFinancieraItems = new ArrayList<SelectItem>();
			for (InstitucionFinanciera ifi : lista) {
				institucionFinancieraItems.add(new SelectItem(ifi
						.getSecInstitucionFinanciera(), ifi
	...
	/**
	 * @param institucionFinancieraItems
	 *            the institucionFinancieraItems to set
	 */
	public void setInstitucionFinancieraItems(
			List<SelectItem> institucionFinancieraItems) {
	...
	public List<SelectItem> getTipoVisaItems() {
		if (tipoVisaItems == null) {
			...
			for (TipoVisa tp : lista) {
				String label = tp.getCodTipoVisa() + " "
						+ tp.getEstadoMigratorio();
